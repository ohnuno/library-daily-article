...
GitHub Pages の URL は `https://{username}.github.io/library-daily-article/` です。

### iframe による埋め込み（推奨）

```html
<iframe
  src="https://{username}.github.io/library-daily-article/widget/"
  width="420"
  height="600"
  frameborder="0"
  style="border:none;">
...
`https://{username}.github.io/library-daily-article/widget/archive.html` で日付別の過去記事を閲覧できます。
